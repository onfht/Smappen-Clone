...
def compute_for_address(
    ...
    return {
        ...
        "poi_meta": poi_meta,
        "dataset_meta": {
            "filosofi_paths": [str(part.path) for part in filosofi_dataset.parts],
            "filosofi_layers": [part.layer for part in filosofi_dataset.parts],
            ...
            "rp_paths": [str(part.path) for part in rp_dataset.parts] if rp_dataset else None,
            "rp_layers": [part.layer for part in rp_dataset.parts] if rp_dataset else None,
